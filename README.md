# fo4-xdi-custom-ui
Custom layout tweaks for Extended Dialogue Interface (XDI). Restyles the XDI dialogue box to match Fallout 4's default subtitle style.
# Requirements
...
* To remove or uninstall it just delete the DialogueMenu.swf
